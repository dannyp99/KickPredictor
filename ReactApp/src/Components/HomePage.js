...
export class HomePage extends Component {
  ...
  sendData = () => {
    var startDate =
      this.state.StartDate === "" ? new Date() : new Date(this.state.StartDate);

    var endDate =
      this.state.EndDate === "" ? new Date() : new Date(this.state.EndDate);
  ...
  render() {
    return (
      <div>
        <h1 style={{ "text-align": "center", color: "rgb(35, 214, 35)" }}>
          KickPredictor{" "}
        </h1>
        ...
        <form>
          <Table size="lg" variant="light" bordered striped>
            <tbody style={{ "text-align": "center" }}>
              <tr>
                <td>
                  <label for="pet-select">Choose State: </label>
              ...
              <tr>
                <td>
                  <label for="date">Starting Date & Time: &nbsp;</label>
                  <input
                    id="RegForm3"
              ...
              <tr>
                <td>
                  <label for="date">Ending Date & Time: &nbsp;</label>
                  <input
                    id="RegForm3"
                    placeholder="YYYY-MM-dd"
              ...
              <tr>
                <td>
                  <Button variant="success" onClick={this.sendData}>
                    Run Prediction
                  </Button>{" "}
                </td>
              </tr>
              {this.state.Result === "" ? (
                ...
                <td>
                  {this.state.Result === "True" ? (
                    ...
                    <h1 style={{ color: "red" }}> Your project will fail! </h1>
                  )}
                </td>
              )}
            </tbody>
